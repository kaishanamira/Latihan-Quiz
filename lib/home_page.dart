...
// Define the vehicle list using the provided data
var vehicleList = [
  Vehicle(
    name: 'Toyota Avanza',
    type: 'SUV',
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            color: Colors.grey[200], // Light gray for card background
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Text elements are styled in black
                      Text(
                        vehicle.name,
                        style:
